      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <div class="form-group" style="display:inline-block;">
                  <label for="harga" style="width:59%;">Harga Barang (Rp)</label>
                  <input type="text" name="harga" style="width:67%;margin-right: 53px;" class="form-control" id="harga" placeholder="Harga Barang (Rp)">
              </div>
            <div class="form-group" style="display:inline-block;">
