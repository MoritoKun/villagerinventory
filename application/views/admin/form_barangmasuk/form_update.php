...
<head>
  ...
  <title>Villager Inventory | Data Barang Masuk</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>Staff</b>Admin</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MASTER PROJECT</li>
        <li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <div class="form-group" style="display:inline-block;">
                  <label for="harga" style="width:65%;margin-left: 12px;">Harga (RP)</label>
                  <input type="text" name="harga" required style="width: 60%;margin-right: 54px;margin-left: 7px;" class="form-control" id="harga" value="<?=$d->harga?>">
                </div>
            <?php } ?>
              <!-- /.box-body -->
